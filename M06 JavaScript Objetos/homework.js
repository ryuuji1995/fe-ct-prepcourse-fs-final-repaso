...
function tienePropiedad(objeto, propiedad) {
   ...
   // Tu código:
   var nuevoArray = [];
   var arrayPropiedad = Object.keys(objeto);

   for (let i=0; i<arrayPropiedad.length; i++) {

      if (arrayPropiedad[i]===propiedad) {
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   var sumaLikes = 0;
   arrayObjetos = objetoUsuario.posts;

   for (let i=0; i<objetoUsuario.posts.length; i++) {
      sumaLikes = sumaLikes + arrayObjetos[i].likes;
